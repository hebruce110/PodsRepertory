...
#else
    return [UIColor colorWithWhite:0 alpha:kHUBALPHA];
#endif
}
...
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    return [UIColor colorWithWhite:200.0f/255.0f alpha:kHUBALPHA];
#else
